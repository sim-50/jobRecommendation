...
(function(){
	...
	//when click on logout, the page redirect to login form
	function logout(){
		var url = './logout';
		var req = null;
	...
	//if the session is valid(log in successfully!!), use function onSessionValid
	...
	//didn't have session? register a new user. 
	//So this method is used for show register form element, and hide others.
	function onSessionInvalid(){
		//set variables for each ingredient in main section 
		var loginForm = document.querySelector('#login-form');
		var registerForm = document.querySelector('#register-form');
		var itemNav = document.querySelector('#item-nav');
		var itemList = document.querySelector('#item-list');
	...
	// -----------------------------------
	function register() {
		//.value: get string from form input
		...
		//form validation: check null input
		...
		//md5 library for password encryption
